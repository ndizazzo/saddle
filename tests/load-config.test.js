...
describe("load-config", () => {
  before(() => {
    tmpDir = makeTempDir("saddle-lc-");
    configPath = path.join(tmpDir, "config.yaml");
    rulesDir = path.join(tmpDir, "rules");
    process.env.SADDLE_CONFIG = configPath;
    process.env.SADDLE_RULES_DIR = rulesDir;
    process.env.SADDLE_DIR = tmpDir;
  });
  ...
  describe("RULES_DIR", () => {
    it("uses SADDLE_RULES_DIR env var", () => {
