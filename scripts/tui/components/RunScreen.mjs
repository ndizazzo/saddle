  ...
  return h(
    ...
    h(
        ...
        ...selectedProfiles.map((profile) => {
          ...
          return h(
            ...
            h(
              ...
              h(ShortLabel, { text: standaloneProfileLabel(profile), color: labelColor, bold: isCurrent }),
            ),
      ...
      h(
        ...
        h(Text, { color: theme.color.fg.primary, bold: true }, currentProfile ? standaloneProfileLabel(currentProfile) : "Preparing"),
        h(Newline, null),
    ...
    h(
      ...
      h(
        ...
        h(Newline, null),
        h(Text, { color: theme.color.fg.muted }, currentProfile ? `Working on ${standaloneProfileLabel(currentProfile)}` : "Preparing install actions"),
