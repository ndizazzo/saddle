...
export async function runInkInstaller({ profiles, options, initialSelectedIds, runInstallation, inspectProfile, buildInspectionCacheAsync, sourceRoot, configPath, writeSourceRoot }) {
